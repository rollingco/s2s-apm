<?php
/**
 * S2S APM SALE — multipart/form-data + Basic Auth
 * - Test MSISDN controls final outcome in Tola sandbox (last 2 digits)
 * - Adds "Check status now" button (links to poll_status.php)
 */
...
$SECRET      = '554999c284e9f29cf95f090d9a8f3171'; // for SALE hash (Appendix A)

$API_USER    = 'leogc';
$API_PASS    = 'ORuIO57N6KJyeJ';

/* ===== RUNTIME (overridable via query) ===== */
...
$msisdn      = $_GET['msisdn'] ?? '254000000000'; // controls test outcome
...
$pollUrl = '/s2stest/Tola/poll_status.php'; // ваш шлях
$qs      = '';
if (is_array($data)) {
...
<head>
<meta charset="utf-8">
<title>SALE – create & quick status link</title>
<style>
